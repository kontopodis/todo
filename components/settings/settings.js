...
export default Settings = ({navigation}) =>{
    ...
    return (
        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={()=>{navigation.navigate("Terms")}} style={styles.settingButton}><Text style={styles.settingText}><Ionicons name="md-trash-sharp" size={24} color="black" />Terms & Conditions</Text></TouchableOpacity>
